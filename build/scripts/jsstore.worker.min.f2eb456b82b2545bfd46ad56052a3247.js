...
var JsStoreWorker = function (e) {
  ...
  var _r,
    ...
    return Object.defineProperty(e.prototype, "activeDb", {
      ...
      switch (t) {
        ...
        case i.g.GreaterThan:
          n = IDBKeyRange.lowerBound(e, !0);
          break;

        case i.g.GreaterThanEqualTo:
    ...
    return e.prototype.check = function (e) {
      ...
      for (var n = 0, r = this.where[e][i.g.In], o = r.length; n < o; n++) {
        if (r[n] === t) {
          this.status = !0;
          break;
        }
      ...
      var n,
          r,
          o,
          u = this.where[e][i.g.Like].split("%");

      switch (u[1] ? (r = u[1], n = u.length > 2 ? i.f.Any : i.f.Last) : (r = u[0], n = i.f.First), t = t.toLowerCase(), n) {
        case i.f.Any:
          (o = t.indexOf(r.toLowerCase())) < 0 && (this.status = !1);
          break;

        case i.f.First:
          ((o = t.indexOf(r.toLowerCase())) > 0 || o < 0) && (this.status = !1);
          break;

        default:
          (o = t.lastIndexOf(r.toLowerCase())) < t.length - r.length && (this.status = !1);
      }
    }, e.prototype.checkRegex = function (e, t) {
      var n = this.where[e][i.g.Regex];
    ...
    return l(t, e), t.prototype.onErrorOccured = function (e, t) {
      if (void 0 === t && (t = !1), t) e.logError(), this.error = e.get();else {
        var n = void 0;
        e.name ? (n = new s.a(e.name)).message = e.message : (n = new s.a(e.target.error.name)).message = e.target.error.message, this.error = n.get();
      }
    }, t.prototype.onExceptionOccured = function (e) {
      console.error(e), this.onError({
        message: e.message,
        type: i.d.InvalidQuery
      });
      ...
      switch (r[1] ? (t = r[1], n = r.length > 2 ? i.f.Any : i.f.Last) : (t = r[0], n = i.f.First), n) {
        case i.f.First:
      ...
      var e = Object(a.a)(this.query.where);
      ...
      if (!0 === this.query.ignoreCase && (this.query.where = this.makeQryInCaseSensitive(this.query.where)), this.objectStore.indexNames.contains(e)) {
        ...
        if ("object" == typeof t) {
          ...
          switch (r) {
            case i.g.Like:
              var o = this.getRegexFromLikeExpression_(t[i.g.Like]);
              this.executeRegexLogic(e, o);
              break;

            case i.g.Regex:
              this.executeRegexLogic(e, t[i.g.Regex]);
              break;

            case i.g.In:
              this.executeInLogic(e, t[i.g.In]);
              break;
        ...
        var u = null == this.getColumnInfo(e, this.tableName) ? new s.a(i.d.ColumnNotExist, {
          column: e
        }) : new s.a(i.d.EnableSearchOff, {
          column: e
        });
        this.onErrorOccured(u, !0);
      }
      ...
      for (var r in e) {
        ...
        switch (Object(h.a)(t)) {
          case i.c.String:
            o = o.concat(this.getAllCombinationOfWord(t)), e[r] = {}, e[r][i.g.In] = o;
            break;

          case i.c.Object:
            for (var u in t) {
              switch (n = t[u], Object(h.a)(n)) {
                case i.c.String:
                  switch (u) {
                    case i.g.Like:
                    case i.g.Regex:
                    ...
                    default:
                      o = o.concat(this.getAllCombinationOfWord(n));
                  }
                ...
                case i.c.Array:
                  switch (u) {
                    case i.g.In:
                      o = Object(h.a)(n[0]) === i.c.String ? o.concat(this.getAllCombinationOfWord(n, !0)) : o.concat(n);
                  }
  ...
  var r = n(0),
    ...
    return e.prototype.check = function (e, t) {
      ...
      if (e.dataType && s && o !== e.dataType && "object" !== o && (n = new i.a(r.d.WrongDataType, {
        ...
        for (var h in t) {
          a.indexOf(h) < 0 && e.dataType && o !== e.dataType && (n = new i.a(r.d.WrongDataType, {
            column: e.name
          }));
          break;
        }
    ...
    return e.prototype.checkAndModifyValues = function () {
      ...
      return Object(h.a)(function (t, n) {
        var r = function r(_r2) {
          e.valueCheckerObj = new a(e.table, _r2), e.startChecking().then(t).catch(n);
        };
  ...
  var _o,
    ...
    return c(t, e), t.prototype.execute = function () {
      ...
      var t, n, r;
      this.errorOccured || (t = v.columnName, n = this.key, (r = e.objectStore.index(t).openCursor(IDBKeyRange.only(n))).onerror = function (t) {
      ...
      u.createTransaction([v.tableName], this.onTransactionCompleted.bind(this)), this.objectStore = u.transaction.objectStore(v.tableName);
    ...
    return a(t, e), t.prototype.execute = function () {
      ...
      this.initTransaction(), (e = t.objectStore.index(v.columnName).openCursor(IDBKeyRange.only(t.query[v.columnName]))).onsuccess = function (e) {
      ...
      u.createTransaction([v.tableName], this.onTransactionCompleted_), this.objectStore = u.transaction.objectStore(v.tableName);
    }, t;
  }(i),
      l = function () {
    function e() {}
    ...
    u.isDbDeletedByBrowser = !1, o.onerror = function (e) {
      "InvalidStateError" === e.target.error.name ? n({
        ...
        type: f.d.IndexedDbNotSupported
      }) : n(e.target.error);
    }, o.onsuccess = function (e) {
      u.dbStatus.conStatus = r.Connected, u.dbConnection = o.result, u.dbConnection.onclose = function () {
        u.callDbDroppedByBrowser(), l.updateDbStatus(r.Closed, f.d.ConnectionClosed);
      }, u.dbConnection.onversionchange = function (e) {
        null === e.newVersion && (e.target.close(), u.callDbDroppedByBrowser(), l.updateDbStatus(r.Closed, f.d.ConnectionClosed));
      ...
      e.target.result.createObjectStore(v.tableName, {
        keyPath: "Key"
      }).createIndex("Key", "Key", {
        unique: !0
      });
    ...
    return _(t, e), t.prototype.execute = function () {
      var e,
          ...
          n,
          r = this;
      this.initTransaction_(), e = v.columnName, t = this.key, (n = r.objectStore.index(e).openCursor(IDBKeyRange.only(t))).onerror = function (e) {
      ...
      u.createTransaction([v.tableName], this.onTransactionCompleted_, "readonly"), this.objectStore = u.transaction.objectStore(v.tableName);
    }, t;
  }(i),
      d = function () {
    function e(e) {
    ...
    return e.init = function () {
      if (indexedDB) return v.prcoessQuery({
        name: "init_db",
        query: null
      });
    }, e.close = function () {
      return v.prcoessQuery({
        name: "close_db",
        query: null
      });
    }, e.get = function (e) {
  ...
  var _r3,
    ...
    return e.prototype.createMetaData = function (e) {
      ...
      var t = this;
      a.a.activeDbVersion = a.a.activeDbVersion > this.version ? a.a.activeDbVersion : this.version, u.a.set("JsStore_" + e + "_Db_Version", a.a.activeDbVersion), u.a.set("JsStore_" + e + "_" + this.name + "_Version", a.a.activeDbVersion).then(function () {
    ...
    return e.prototype.createMetaData = function () {
      var e = this;
      return Object(x.a)(this.tables.map(function (t) {
        return new w(t).createMetaData(e.dbName);
      }));
    }, e;
  }(),
      S = function S(e) {
    ...
    return T(t, e), t.prototype.execute = function (e, t, n) {
      var r,
          o = 0,
          i = {},
          u = !0,
      ...
      var a = function a() {
        if (o < e.length) new d.a(e[o++], function (e) {
          e.forEach(function (e) {
            i[r(e)] = e;
          }), a();
        }, n).execute();else {
    ...
    return P(t, e), t.prototype.execute = function (e, t, n) {
      var r = this;
      this.query = e;
      var o,
          i = 0,
      ...
      if (a.every(function (e, t) {
        return !(t + 1 < h && e.from !== a[t + 1].from) || (s = !1, !1);
      }), s) {
        var l = this.getPrimaryKey(a[0].from);
      ...
      var f = function f() {
        if (i < h) new d.a(a[i], function (e) {
          ...
          if (p = e.skip && e.limit ? function () {
            m(function () {
              g();
            });
          } : e.limit ? g : e.skip ? function () {
            m(function () {
              v();
            });
          } : function () {
          ...
          r.results = l, r.query.join = {}, r.processOrderBy(), r.processGroupDistinctAggr(), t(r.results);
        }
      };
    ...
    return e.prototype.checkConnectionAndExecuteLogic = function (e) {
      ...
      switch (E.a.log("request executing:" + e.name), e.name) {
        case l.a.InitDb:
        case l.a.IsDbExist:
      ...
      D.a.isLogEnabled = e, t();
    }, e.prototype.returnResult_ = function (e) {
      !0 === D.a.isRuningInWorker ? self.postMessage(e) : this.onQueryFinished(e);
      ...
      null != this.activeDb_ && this.activeDb_.name === e ? this.processCreateDb(this.activeDb_).then(t).catch(n) : this.getDbSchema_(e).then(function (o) {
        null != o ? r.processCreateDb(o).then(t).catch(n) : n(new E.a(l.d.DbNotExist, {
          dbName: e
        }).get());
      }).catch(n);
      ...
      return Object(p.a)(function (n, r) {
        new k(e).createMetaData().then(function (o) {
          t.activeDb_ = e, new y(function (r) {
            t.activeDb_ = e, r && u.a.set("JsStore_" + e.name + "_Schema", e), n(r);
          }, r).execute(o);
        });
      });
  ...
  var _r5,
    ...
    return e.prototype.setCaseAndValue = function (e, t) {
      ...
      for (var e = 0; e < this.length_; e++) {
        if (!0 === this.checkCase_(this.caseColumnQuery_[e])) return this.caseColumnQuery_[e].then;
      }
      ...
      for (t in e) {
        switch (t) {
          ...
          case v.g.GreaterThanEqualTo:
            if (this.value[this.columnName_] >= e[t]) return !0;
            break;

          case v.g.LessThanEqualTo:
            if (this.value[this.columnName_] <= e[t]) return !0;
            break;
    ...
    function t() {
      var t = null !== e && e.apply(this, arguments) || this;
      return t.sorted = !1, t.isSubQuery = !1, t.shouldEvaluateLimitAtEnd = !1, t.shouldEvaluateSkipAtEnd = !1, t.thenEvaluator = new g(), t;
    }

    return m(t, e), t.prototype.setPushResult = function () {
      var e = this;
      this.query.case ? this.pushResult = function (t) {
        var n;

        for (n in e.thenEvaluator.setCaseAndValue(e.query.case, t), e.query.case) {
          t[n] = e.thenEvaluator.setColumn(n).evaluate();
        }
    ...
    return D(t, e), t.prototype.executeWhereUndefinedLogic = function () {
      if (this.query.order && !1 !== this.query.order.idbSorting && this.query.order.by) {
        if (!this.objectStore.indexNames.contains(this.query.order.by)) {
          var e = new E.a(v.d.ColumnNotExist, {
      ...
      o.onerror = this.onErrorOccured, !1 === this.shouldEvaluateLimitAtEnd && !1 === this.shouldEvaluateSkipAtEnd ? this.skipRecord && this.limitRecord ? this.executeSkipAndLimitForNoWhere_() : this.skipRecord ? this.executeSkipForNoWhere_() : this.limitRecord ? this.executeLimitForNotWhere_() : this.executeSimpleForNotWhere_() : this.executeSimpleForNotWhere_();
    ...
    return S(t, e), t.prototype.executeInLogic = function (e, t) {
      var n = this;
      c = this.skipRecord, u = function u(e) {
        0 === c ? n.pushResult(e) : --c;
      }, i = function i() {
        return n.whereCheckerInstance.check(s.value);
      }, !1 === this.shouldEvaluateLimitAtEnd && !1 === this.shouldEvaluateSkipAtEnd ? this.skipRecord && this.limitRecord ? this.executeSkipAndLimitForIn_(e, t) : this.skipRecord ? this.executeSkipForIn_(e, t) : this.limitRecord ? this.executeLimitForIn_(e, t) : this.executeSimpleForIn_(e, t) : this.executeSimpleForIn_(e, t);
    }, t.prototype.executeSkipAndLimitForIn_ = function (e, t) {
      var n,
          r = this,
          o = this.objectStore.index(e);
      Object(k.a)(t.map(function (e) {
        return t = e, Object(x.a)(function (e, c) {
          (n = o.openCursor(r.getKeyRange(t))).onsuccess = function (t) {
            s = t.target.result, r.results.length !== r.limitRecord && s ? (i() && u(s.value), s.continue()) : e();
          }, n.onerror = c;
        });
        var t;
      })).then(function () {
      ...
      Object(k.a)(t.map(function (e) {
        return t = e, Object(x.a)(function (e, c) {
          (n = o.openCursor(r.getKeyRange(t))).onsuccess = function (t) {
            (s = t.target.result) ? (i() && u(s.value), s.continue()) : e();
          }, n.onerror = c;
        });
        var t;
      })).then(function () {
      ...
      Object(k.a)(t.map(function (e) {
        return t = e, Object(x.a)(function (e, u) {
          (n = o.openCursor(r.getKeyRange(t))).onsuccess = function (t) {
            (s = t.target.result) && r.results.length !== r.limitRecord ? (i() && r.pushResult(s.value), s.continue()) : e();
          }, n.onerror = u;
        });
        var t;
      })).then(function () {
      ...
      Object(k.a)(t.map(function (e) {
        return t = e, Object(x.a)(function (e, u) {
          (n = o.openCursor(r.getKeyRange(t))).onsuccess = function (t) {
            (s = t.target.result) ? (i() && r.pushResult(s.value), s.continue()) : e();
          }, n.onerror = u;
        });
        var t;
      })).then(function () {
    ...
    return q(t, e), t.prototype.executeRegexLogic = function (e, t) {
      var n = this;
      l = this.skipRecord, this.regexExpression = t, h = function h(e) {
        0 === l ? n.pushResult(e) : --l;
      }, a = function a() {
      ...
      p.onsuccess = function (t) {
        f = t.target.result, e.results.length !== e.limitRecord && f ? (a() && e.pushResult(f.value), f.continue()) : e.onQueryFinished();
      };
    }, t.prototype.executeSimpleForRegex_ = function () {
      var e = this;

      p.onsuccess = function (t) {
        (f = t.target.result) ? (a() && e.pushResult(f.value), f.continue()) : e.onQueryFinished();
      };
    }, t;
  }(C),
      T = function () {
    ...
    return T(t, e), t.prototype.executeWhereLogic = function (e, t, n, r) {
      var o = this;
      _ = function _() {
      ...
      d.onsuccess = function (n) {
        (y = n.target.result) ? t && e.results.length !== e.limitRecord ? (_() && e.pushResult(y.value), y.continue()) : (t = !0, y.advance(e.skipRecord)) : e.onQueryFinished();
      };
      ...
      d.onsuccess = function (n) {
        (y = n.target.result) ? t ? (_() && e.pushResult(y.value), y.continue()) : (t = !0, y.advance(e.skipRecord)) : e.onQueryFinished();
      };
    }, t.prototype.executeLimitForWhere_ = function () {
      var e = this;

      d.onsuccess = function (t) {
        (y = t.target.result) && e.results.length !== e.limitRecord ? (_() && e.pushResult(y.value), y.continue()) : e.onQueryFinished();
      };
    }, t.prototype.executeSimpleForWhere_ = function () {
      var e = this;

      d.onsuccess = function (t) {
        (y = t.target.result) ? (_() && e.pushResult(y.value), y.continue()) : e.onQueryFinished();
      };
    }, t;
  }(j),
      A = n(33),
    ...
    return L(t, e), t.prototype.processGroupBy = function () {
      var e = this.query.groupBy,
          t = this.results,
          n = {};
      if (this.results = this.query.groupBy = null, Object(A.a)(e) !== v.c.Object) {
        if (Object(A.a)(e) === v.c.String) for (var r in t) {
          n[t[r][e]] = t[r];
        } else {
          var o = void 0;
        ...
        for (var r in this.thenEvaluator.setCaseAndColumn(e, u), t) {
          n[this.thenEvaluator.setValue(t[r]).evaluate()] = t[r];
        }
      } else {
        o = void 0;

        for (var r in t) {
          for (var i in o = "", this.thenEvaluator.setCaseAndValue(e, t[r]), e) {
            o += this.thenEvaluator.setColumn(i).evaluate();
          }
      ...
      if (Object(A.a)(e) === v.c.String) for (n in t) {
        r = t[n][e], s(), u[r] = t[n];
      } else for (n in t) {
        for (var a in r = "", e) {
          r += t[n][e[a]];
      ...
      if (c.avg) if (Object(A.a)(c.avg) === v.c.String) for (n in t) {
        var l = t[n]["sum(" + c.avg + ")"],
            f = t[n]["count(" + c.avg + ")"];
        t[n]["avg(" + c.avg + ")"] = l / f, c.count !== c.avg && delete t[n]["count(" + c.avg + ")"], c.sum !== c.avg && delete t[n]["sum(" + c.avg + ")"];
      } else {
        var p = Object(A.a)(c.count) === v.c.String,
            _ = Object(A.a)(c.sum) === v.c.String;
        ...
        for (n in t) {
          for (var a in c.avg) {
            var y = c.avg[a],
                d = t[n]["sum(" + y + ")"],
                b = t[n]["count(" + y + ")"];
            t[n]["avg(" + y + ")"] = d / b, p && (c.count !== y || -1 === c.count.indexOf(y)) && delete t[n]["count(" + y + ")"], _ && (c.sum !== y || -1 === c.sum.indexOf(y)) && delete t[n]["sum(" + y + ")"];
          }
        }
      }
      this.results = t;
    ...
    return Q(t, e), t.prototype.processGroupDistinctAggr = function () {
      ...
      if (null == this.query.join) t = this.getColumnInfo(e, this.query.from);else {
        var n = Object(N.a)(e).split(".");
        e = n[1], t = this.getColumnInfo(e, n[0]);
      }
      return null == t && this.onErrorOccured(new E.a(v.d.ColumnNotExist, {
        column: e,
        isOrder: !0
      }), !0), t;
      ...
      for (var r in n) {
        ...
        var i = this.thenEvaluator.setColumn(r).evaluate();

        switch (typeof e[o]) {
          case v.c.String:
            return this.compareStringInDesc_(e[o], t[i]);

          default:
            return this.compareNumberInDesc_(e[o], t[i]);
        }
      }
      ...
      for (var r in n) {
        ...
        switch (typeof e[o]) {
          case v.c.String:
            return this.compareStringinAsc_(e[o], t[i]);

          default:
            return this.compareNumberinAsc_(e[o], t[i]);
        }
      }
      ...
      var r = e.by;
      if (null != r && typeof r === v.c.Object) "asc" === e.type ? this.results.sort(function (e, t) {
        ...
        if (null != o) {
          var i = this.getValueComparer_(o, e);
          r = o.name, null == e.case ? this.results.sort(function (e, t) {
            return i(e[r], t[r]);
          }) : (this.thenEvaluator.setCaseAndColumn(((t = {})[r] = e.case, t), r), this.results.sort(function (e, t) {
            return i(n.thenEvaluator.setValue(e).evaluate(), n.thenEvaluator.setValue(t).evaluate());
          }));
        }
      }
      ...
      if (e && this.results.length > 0 && !this.sorted) {
        var t = Object(A.a)(e);
        if (t === v.c.Object) this.orderBy_(e);else if (t === v.c.Array) {
          this.orderBy_(e[0]);
  ...
  var _r6,
    ...
    return a(t, e), t.prototype.deleteMetaData = function () {
      ...
      return Object(s.a)(function (t, n) {
        i.a.remove("JsStore_" + e.dbName + "_Db_Version"), e.activeDb.tables.forEach(function (t) {
          i.a.remove("JsStore_" + e.dbName + "_" + t.name + "_Version"), t.columns.forEach(function (n) {
            n.autoIncrement && i.a.remove("JsStore_" + e.dbName + "_" + t.name + "_" + n.name + "_Value");
          });
        }), e.getDbList().then(function (r) {
          r.splice(r.indexOf(e.dbName), 1), e.setDbList(r).then(function () {
            i.a.remove("JsStore_" + e.dbName + "_Schema").then(t).catch(n);
          });
        });
      });
      ...
      setTimeout(function () {
        ...
        t.onblocked = function () {
          null != e.onError_ && e.onError_(new u.a(o.d.DbBlocked).get());
        }, t.onerror = function (t) {
          null != e.onError_ && e.onError_(event.target.error);
        }, t.onsuccess = function () {
          e.deleteMetaData().then(function () {
            e.onSuccess_(), e.dbStatus.conStatus = o.b.Closed;
          }).catch(e.onError_);
        };
      }, 100);
    }, t;
  ...
  n.r(t), n.d(t, "QueryExecutor", function () {
    return r.a;
  ...
  var _r7,
    ...
    return a(t, e), t.prototype.execute = function () {
      var e = this,
          t = new s.a(i.a.Insert, this.query);
      ...
      n = !0 === this.query.return ? function (e) {
        ...
        ++r.rowAffected;
      }, this.createTransaction([this.tableName], this.onTransactionCompleted_), t = this.transaction.objectStore(this.tableName), Object(u.a)(e.map(function (e) {
  ...
  var _r8,
    ...
    return y(t, e), t.prototype.executeWhereLogic = function (e, t, n) {
      var r,
          o,
          i = this;
      t = n ? t[n] : t, (1 === Object.keys(this.query.where).length && this.objectStore.count ? function () {
    ...
    return O(t, e), t.prototype.execute = function () {
      var e = this,
          t = new g.a(b.a.Count, this.query);
      if (t.checkAndModify(), null == t.error) try {
        var n = function n() {
          new v.a(e.query, function (t) {
      ...
      this.createTransaction([this.query.from], this.onTransactionCompleted_, b.e.ReadOnly), this.objectStore = this.transaction.objectStore(this.query.from);
    }, t;
  }(d);
}, function (e, t, n) {
  "use strict";
  ...
  var _r9,
    ...
    return E(t, e), t.prototype.execute = function () {
      var e = new g.a(b.a.Remove, this.query);
      ...
      var e = this,
          t = new v.a(this.query, function (t) {
        var n,
            r,
            o = [],
        ...
        var u = ((n = {})[i] = ((r = {})[b.g.In] = o, r), n);
        e.query.ignoreCase = null, e.query[b.g.Where] = u, e.processWhere_();
      }, this.onError);
  ...
  var _r10,
    ...
    _r10(e, t), e.prototype = null === t ? Object.create(t) : (n.prototype = t.prototype, new n());
  }),
      s = function s(e, t) {
    for (var n in e) {
      if (Object(i.a)(e[n]) !== u.c.Object) t[n] = e[n];else for (var r in e[n]) {
        switch (r) {
          case "+":
            t[n] += e[n][r];
            break;
    ...
    return v(t, e), t.prototype.executeWhereLogic = function (e, t, n) {
      var r,
          o,
          i = this;
      t = n ? t[n] : t, (o = this.objectStore.index(e).openCursor(this.getKeyRange(t, n))).onsuccess = function (e) {
    ...
    return D(t, e), t.prototype.execute = function () {
      var e = new O.a(u.a.Update, this.query);
      if (e.checkAndModify(), null == e.error) try {
        this.initTransaction(), null != this.query.where ? this.query.where.or || Object(E.a)(this.query.where) ? this.executeComplexLogic_() : this.goToWhereLogic() : this.executeWhereUndefinedLogic();
      } catch (e) {
        this.onExceptionOccured(e);
      } else this.onError(e.error);
      ...
      var e = this,
        ...
        var c = ((n = {})[o] = ((r = {})[u.g.In] = i, r), n);
        e.query.ignoreCase = null, e.query[u.g.Where] = c, e.initTransaction(), e.goToWhereLogic();
      }, this.onError);
      t.isSubQuery = !0, t.execute();
    }, t;
  }(g);
  ...
  var _r11,
    ...
    _r11(e, t), e.prototype = null === t ? Object.create(t) : (n.prototype = t.prototype, new n());
  }),
      _h = function h() {
    ...
    return a(t, e), t.prototype.executeJoinQuery = function () {
      var e = this,
          t = this.query;
      Object(c.a)(t.join) === o.c.Object ? this.joinQueryStack_ = [t.join] : this.joinQueryStack_ = t.join;
      var n = t.from;
      new b({
        from: n,
        where: t.where,
      ...
      if (null == this.error) {
        if (this.results.length > 0) {
          this.query[o.g.Skip] && !this.query[o.g.Limit] && this.results.splice(0, this.query[o.g.Skip]);
          ...
          try {
            ...
            return void this.onError({
              message: e.message,
              type: o.d.InvalidJoinQuery
            });
          }

          this.query[o.g.Skip] && this.query[o.g.Limit] ? (this.results.splice(0, this.query[o.g.Skip]), this.results = this.results.slice(0, this.query[o.g.Limit])) : this.query[o.g.Limit] && (this.results = this.results.slice(0, this.query[o.g.Limit]));
        }
      ...
      var r,
          ...
          p = this.currentQueryStackIndex_ + 1;

      switch (e) {
        case "left":
          i = 0, u = {}, c.getTable(t.table2.table).columns.forEach(function (e) {
            u[e.name] = null;
            ...
            }, n.forEach(o), 0 === r.length && (r = [u]), r.forEach(function (t) {
              s[i] = _h({}, e), s[i++][p] = t;
            });
          });
          break;
      ...
      var n,
          r = e.table1,
          i = e.table2,
          c = this.getTable(r.table),
          s = this.getTable(i.table);
      t.with !== i.table && (n = new u.a(o.d.InvalidJoinQuery, "on value should contains value of with")), null == c.columns.find(function (e) {
        return e.name === r.column;
      }) ? n = new u.a(o.d.InvalidJoinQuery, "column " + r.column + " does not exist in table " + r.table) : null == s.columns.find(function (e) {
        return e.name === i.column;
      }) && (n = new u.a(o.d.InvalidJoinQuery, "column " + i.column + " does not exist in table " + i.table)), null == t.as && (t.as = {}), c.columns.every(function (e) {
        var c = s.columns.find(function (t) {
          return t.name === e.name && t.name !== r.column;
        });
        return null == c || null != t.as[c.name] || (n = new u.a(o.d.InvalidJoinQuery, "column " + e.name + " exist in both table " + r.table + " & " + i.table), !1);
    ...
    function t(t, n, r) {
      var o = e.call(this) || this;
      return o.onTransactionCompleted_ = function () {
        null == o.error ? (o.processOrderBy(), o.error ? o.onError(o.error) : (o.shouldEvaluateSkipAtEnd && o.results.splice(0, o.query.skip), !0 === o.shouldEvaluateLimitAtEnd && (o.results = o.results.slice(0, o.query.limit)), o.processGroupDistinctAggr(), o.onSuccess(o.results))) : o.onError(o.error);
      }, o.onError = r, o.onSuccess = n, o.query = t, o.tableName = t.from, o.setPushResult(), Object(p.a)(o.query.where) ? (o.isArrayQry = !0, o.shouldEvaluateLimitAtEnd = !0, o.shouldEvaluateSkipAtEnd = !0) : (o.skipRecord = t.skip, o.limitRecord = t.limit), t.order && ((Object(p.a)(t.order) || null != t.order.case || "object" == typeof t.order.by) && (o.query.order.idbSorting = !1), null != t.limit && (o.shouldEvaluateLimitAtEnd = !0), null != t.skip && (o.shouldEvaluateSkipAtEnd = !0)), o;
    }

    return y(t, e), t.prototype.execute = function () {
      var e = new f.a(o.a.Select, this.query);
      if (e.checkAndModify(), null == e.error) try {
        null == this.query.join ? null != this.query.where ? (this.initTransaction_(), Object(p.a)(this.query.where) ? this.processWhereArrayQry() : this.processWhere_()) : (this.initTransaction_(), this.executeWhereUndefinedLogic()) : this.executeJoinQuery();
      } catch (e) {
        this.onExceptionOccured(e);
      } else this.onError(e.error);
    }, t.prototype.processWhereArrayQry = function () {
      ...
      var t,
          ...
          c = function c() {
        if (t === o.g.And) {
          !0 === i ? u = e.results : u.length > 0 && (c = [], e.results.forEach(function (e) {
            var t;
            t = e[r], u.findIndex(function (e) {
              return e[r] === t;
            }) >= 0 && c.push(e);
          }), u = c, c = null);
        } else u.length > 0 ? (e.results = d(u, e.results), e.removeDuplicates(), u = e.results) : u = e.results;

        var c;
        i = !1, n.length > 0 ? (e.results = [], s()) : (e.results = u, !0 === e.isSubQuery && e.onTransactionCompleted_());
      },
          s = function s() {
        e.query.where = n.shift(), e.query.where[o.g.Or] && 1 === Object.keys(e.query.where).length ? (t = o.g.Or, e.query.where = e.query.where[o.g.Or], e.onWhereArrayQrySuccess = c) : (t = o.g.And, e.onWhereArrayQrySuccess = c), e.processWhere_();
      };
      ...
      this.createTransaction([this.tableName], this.onTransactionCompleted_, o.e.ReadOnly), this.objectStore = this.transaction.objectStore(this.tableName);
    }, t.prototype.processWhere_ = function () {
      ...
      if (this.orInfo.results = d(this.orInfo.results, this.results), !this.query.limit || this.query.limit > this.orInfo.results.length) {
        this.results = [];
        var e = Object(_.a)(this.orInfo.orQuery);
  ...
  var _common_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0),
      _base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6),
      _select_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30),
      _count_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27),
      _insert_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(26),
      _remove_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(28),
      _update_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(29),
      ...
      _helpers_index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(15),
      _helpers_index__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(25),
      _helpers_index__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(14),
      _config__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(9),
    ...
    return __extends(Instance, _super), Instance.prototype.execute = function () {
      ...
      }).catch(this.onError) : this.onError(new _log_helper__WEBPACK_IMPORTED_MODULE_8__.a(_common_index__WEBPACK_IMPORTED_MODULE_0__.d.TableNotExist, {
        tableName: t
      }).get());
      ...
      var _this = this,
        ...
        return _this.pushRequest_({
          name: _common_index__WEBPACK_IMPORTED_MODULE_0__.a.Select,
          query: e
        });
      },
          insert = function insert(e) {
        return _this.pushRequest_({
          name: _common_index__WEBPACK_IMPORTED_MODULE_0__.a.Insert,
          query: e
        });
      },
          update = function update(e) {
        return _this.pushRequest_({
          name: _common_index__WEBPACK_IMPORTED_MODULE_0__.a.Update,
          query: e
        });
      },
          remove = function remove(e) {
        return _this.pushRequest_({
          name: _common_index__WEBPACK_IMPORTED_MODULE_0__.a.Remove,
          query: e
        });
      },
          count = function count(e) {
        return _this.pushRequest_({
          name: _common_index__WEBPACK_IMPORTED_MODULE_0__.a.Count,
          query: e
        });
      },
      ...
      switch (this.isQueryExecuting = !0, e.name) {
        case _common_index__WEBPACK_IMPORTED_MODULE_0__.a.Select:
          t = new _select_index__WEBPACK_IMPORTED_MODULE_2__.a(e.query, this.onRequestFinished_.bind(this), this.onError.bind(this));
          break;

        case _common_index__WEBPACK_IMPORTED_MODULE_0__.a.Insert:
          t = new _insert_index__WEBPACK_IMPORTED_MODULE_4__.a(e.query, this.onRequestFinished_.bind(this), this.onError.bind(this));
          break;

        case _common_index__WEBPACK_IMPORTED_MODULE_0__.a.Update:
          t = new _update_index__WEBPACK_IMPORTED_MODULE_6__.a(e.query, this.onRequestFinished_.bind(this), this.onError.bind(this));
          break;

        case _common_index__WEBPACK_IMPORTED_MODULE_0__.a.Remove:
          t = new _remove_index__WEBPACK_IMPORTED_MODULE_5__.a(e.query, this.onRequestFinished_.bind(this), this.onError.bind(this));
          break;

        case _common_index__WEBPACK_IMPORTED_MODULE_0__.a.Count:
          t = new _count_index__WEBPACK_IMPORTED_MODULE_3__.a(e.query, this.onRequestFinished_.bind(this), this.onError.bind(this));
      }
  ...
  }(_base__WEBPACK_IMPORTED_MODULE_1__.a);
}]);